...
val troubleshootQuestions = listOf(
    ...
    TroubleshootItem("Why isn't the widget updating?", "Android limits widget updates to save battery. Ensure the app is not 'Battery Optimized' in app system settings."),
